...
export declare type DurationInMs = number;
export declare type PriceFeedRequestConfig = {
    verbose?: boolean;
    binary?: boolean;
};
export declare type PriceServiceConnectionConfig = {
...
export declare type PriceFeedUpdateCallback = (priceFeed: PriceFeed) => void;
