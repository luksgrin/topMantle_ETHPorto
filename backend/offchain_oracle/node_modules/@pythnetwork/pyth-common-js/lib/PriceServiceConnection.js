...
const pyth_sdk_js_1 = require("@pythnetwork/pyth-sdk-js");
...
class PriceServiceConnection {
    ...
    async getLatestPriceFeeds(priceIds) {
        ...
        return priceFeedsJson.map((priceFeedJson) => pyth_sdk_js_1.PriceFeed.fromJson(priceFeedJson));
    }
    /**
    ...
    async startWebSocket() {
        ...
        this.wsClient.onMessage = (data) => {
            ...
            if (message.type === "response") {
                ...
                let priceFeed;
                try {
                    priceFeed = pyth_sdk_js_1.PriceFeed.fromJson(message.price_feed);
                }
                catch (e) {
